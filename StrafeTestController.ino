// FOR TESTING STRAFING IN STRAIGHT LINE
...
void loop() {
  ...
  StrafeController(reference_x, reference_y, reference_z, Kp_x, Ki_x, Kp_y, Ki_y, Kp_z, Ki_z);  

} 

void StrafeController(double reference_x, double reference_y, double reference_z, double Kp_x, double Ki_x, double Kp_y, double Ki_y, double Kp_z, double Ki_z){
  ...
  IR_avg = (IR_LONG_1_DIST + IR_LONG_2_DIST) / 2; // get distance from wall
  ...
  double V_y = PID_Controller(reference_y, IR_avg, Kp_y, Ki_y);
